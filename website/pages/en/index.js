  ...
  render() {
    ...
    const ProjectTitle = () => (
      <h2 className="projectTitle">
        <img
          src={`${baseUrl}img/logo/logo-word-color.svg`}
          alt="Project Logo"
        />
    ...
    return (
      <SplashContainer>
        {/* <Logo img_src={`${baseUrl}img/logo/logo-color.svg`} /> */}
        <div className="inner">
          <ProjectTitle />
          <PromoSection>
        ...
        {[
          {
            ...
            image: `${baseUrl}img/illustrations/RequestWhatYouNeed.svg`,
            imageAlign: 'left',
        ...
        {[
          {
            ...
            image: `${baseUrl}img/illustrations/UseAnyDatabase.svg`,
            imageAlign: 'left',
        ...
        {[
          {
            ...
            image: `${baseUrl}img/illustrations/Secure.svg`,
            imageAlign: 'top',
            title: 'Secure',
          },
          {
          ...
          },
          {
            ...
            image: `${baseUrl}img/illustrations/EasyToUse.svg`,
            imageAlign: 'top',
            title: 'Easy To Use',
          },
        ]}
